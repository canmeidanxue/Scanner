...
extern "C" jstring Java_com_administrator_zxinglibrary_decode_DecodeEntry_decodeFromJNI(JNIEnv *env, jobject thiz,
                                                                     jint decodeCode,
                                                                     jbyteArray data,
                                                                     jint dataWidth,
                                                                     jint dataHeight,
...
extern "C" jstring Java_com_administrator_zxinglibrary_decode_DecodeEntry_decodeFileFromJNI(JNIEnv *env, jobject thiz,
                                                                         jint decodeCode,
                                                                         jintArray pixels,
