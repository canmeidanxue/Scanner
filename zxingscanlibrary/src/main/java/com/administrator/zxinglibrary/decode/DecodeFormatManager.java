package com.administrator.zxinglibrary.decode;
...
//                BarcodeFormat.CODABAR,
    ...
    static {
        ...
        FORMATS_FOR_MODE.put(Tool.ScanMode.ONE_D_MODE, ONE_D_FORMATS);
        FORMATS_FOR_MODE.put(Tool.ScanMode.PRODUCT_MODE, PRODUCT_FORMATS);
        FORMATS_FOR_MODE.put(Tool.ScanMode.QR_CODE_MODE, QR_CODE_FORMATS);
        FORMATS_FOR_MODE.put(Tool.ScanMode.DATA_MATRIX_MODE, DATA_MATRIX_FORMATS);
    }
