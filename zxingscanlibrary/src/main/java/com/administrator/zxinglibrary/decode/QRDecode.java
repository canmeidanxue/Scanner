...
public final class QRDecode {
    ...
    public static void parsePhoto(final String path, final OnScannerCompletionListener listener) {
        new AsyncTask<String, Integer, String>() {
            @Override
            protected String doInBackground(String... params) {
                return DecodeEntry.decodeFromFile(path,null);
            }

            @Override
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                listener.OnScannerCompletion(s);
            }
        }.execute(path);
    }
