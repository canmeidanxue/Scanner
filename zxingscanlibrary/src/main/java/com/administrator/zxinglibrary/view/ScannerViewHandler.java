...
import com.administrator.zxinglibrary.decode.DecodeThread;
...
//                scannerView.handleDecode((Result) message.obj, barcode, scaleFactor);
    ...
    public void quitSynchronously() {
        ...
        Message quit = Message.obtain(decodeThread.getHandler(), Tool.QUIT);
        quit.sendToTarget();
        try {
        ...
        removeMessages(Tool.DECODE_SUCCEEDED);
        removeMessages(Tool.DECODE_FAILED);
    }
